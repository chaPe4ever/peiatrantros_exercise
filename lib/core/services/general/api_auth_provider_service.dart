...
import 'package:peiatrantros_exercise/core/enums/enum_http_method.dart';
import 'package:peiatrantros_exercise/core/services/general/dio_service.dart';
import 'package:peiatrantros_exercise/core/utils/custom_exception.dart';
...
// Fields
  ...
  late Dio _apiAuthManager;
  late Dio _apiManager;
  ...
  dynamic _populateResponse(
      ...
      required EnumHttpMethod httpMethod,
  ...
  @override
  Future<dynamic> deleteAsync({required String path, String? authToken}) async {
    try {
  ...
  @override
  Future<dynamic> getAsync({required String path, String? authToken}) async {
    try {
      return _populateResponse(
  ...
  Future<dynamic> postAsync(
      {required String path, dynamic? data, String? authToken}) async {
    try {
      return _populateResponse(
